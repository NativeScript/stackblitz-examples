<template>
  <Page>
    ...
    <StackLayout class="p-5">
        ...
        <Button :text="isListening ? 'Stop Listening to Battery Changes' : 'Listen for battery changes'" class="py-2 px-2 mt-4 rounded-full bg-blue-400 text-lg text-white" @tap="toggleListenForChanges" />
        <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/2367px-Vue.js_Logo_2.svg.png" width="200" class="mt-5"/>
    </StackLayout>
  </Page>
</template>
